<?php get_header() ?>
<?php
$list_product_cart = get_list_product_cart();
?>
                                ...
                                <div id="order-review-wp" class="fl-right">
                                    ...
                                    <div class="detail">
                                        <table class="shop-table">
                                            <thead>
                                                <tr>
                                                    <td>Sản phẩm(<?php echo count($list_product_cart) ?>)</td>
                                                    <td>Tổng</td>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            <tfoot>
                                                <tr class="order-total">
                                                    <td>Tổng đơn hàng:</td>
                                                    <td><strong class="total-price"><?php echo currency_format(get_bill())  ?></strong></td>
                                                </tr>
                                            </tfoot>
                                        </table>
